...
public class TracerOkhttpRestControllerTests {

    /**
     * 日志记录器对象
     */
    private static final Logger logger = LoggerFactory.getLogger(TracerOkhttpRestControllerTests.class);
    ...
    public void okhttp() throws Exception {
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/okhttp").param("name", "okhttp"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.content").value("Hello, okhttp!")) // 添加 jsonPath 断言
    ...
    /**
     * okhttp 调用 case 需要先启动项目才能跑过，所以先屏蔽掉
     *
     * @throws Exception
     */
    @Test
